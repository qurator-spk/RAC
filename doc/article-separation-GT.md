...
* prev_part: Wenn das Polygon Teil einer Sequenz ist und es ein vorheriges Polygon gibt, ist dies die ID des vorherigen Polyhons. Ansonsten gilt next_part="not_specified".
